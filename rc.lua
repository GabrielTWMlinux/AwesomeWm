...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,         },   "f",       function () awful.spawn("alacritty -e fff") end,
        {descrption = "Open fff", group = "Personal launchers"}),
    awful.key({ "Shift"         },   "m",      function () awful.spawn("/home/gabriel/Scripts/volup") end,
        {description = "exec volup", group = "Personal launchers"}),
    awful.key({ "Shift"         },   "n",      function () awful.spawn("/home/gabriel/Scripts/voldown") end,
        {descritipn = "exec voldown", group = "Personal launchers"}),
    awful.key({ "Shift"         },   "d",      function () awful.spawn("/home/gabriel/Scripts/time_date") end,
        {descritipn = "exec time_date", group = "Personal launchers"}),
